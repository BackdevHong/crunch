...
export default function ApplyFreelancer({ onNavigate }) {
  ...
  const handleSubmit = async () => {
    if (!form.role) { setError('직무를 입력해주세요.'); return }
    ...
    return (
      <div className={styles.page}>
        <div className={styles.successWrap}>
          ...
          <h2>신청이 완료되었습니다</h2>
          <p>검토 후 승인 여부를 안내드릴게요.<br />보통 1~3일 이내에 처리됩니다.</p>
  ...
  return (
    <div className={styles.page}>
      <div className={styles.hero}>
        ...
        <p>심사 후 승인되면 서비스 등록과 프로젝트 지원을 시작할 수 있습니다.</p>
      </div>
      ...
      <div className={styles.formWrap}>
        <div className={styles.card}>
          ...
          <div className={styles.field}>
            <label>직무 <span className={styles.required}>*</span></label>
            <input
              type="text"
        ...
        <div className={styles.card}>
          ...
          <div className={styles.field}>
            <label>자기소개</label>
            <textarea
              placeholder="경력, 전문 분야, 작업 스타일을 소개해주세요."
              value={form.bio}
